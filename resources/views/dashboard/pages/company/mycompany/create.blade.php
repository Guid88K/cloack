                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="v-home">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="white" class="form-control" placeholder="White page">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Black page</label>
                                <input type="text" name="black" class="form-control" placeholder="Black page">
                            </div>
                        ...
                        <div class="tab-pane" id="v-geo">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="geo" class="form-control" placeholder="Страна">
                            </div>
                        </div>
                        <div class="tab-pane" id="v-ip">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="ip" name="ip" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="v-device">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <!-- Default inline 3-->
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" name="device[]" value="Linux"
                                               id="Linux">
